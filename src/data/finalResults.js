...
// real retrospective. Each card also carries two evaluative badges (certainty-impact
// addendum): `certainty` (how directly the claim derives from the data) and `impact` (how
// much it shaped Hotel Red's final outcome), each Low | Medium | High. Read-only.
